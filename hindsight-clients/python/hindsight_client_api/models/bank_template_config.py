...
class BankTemplateConfig(BaseModel):
    ...
    consolidation_protected_vocabularies: Optional[List[Dict[str, Any]]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if consolidation_protected_vocabularies (nullable) is None
        # and model_fields_set contains the field
        if self.consolidation_protected_vocabularies is None and "consolidation_protected_vocabularies" in self.model_fields_set:
            _dict['consolidation_protected_vocabularies'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consolidation_protected_vocabularies": obj.get("consolidation_protected_vocabularies"),
